...
class AppointmentServiceUnitTests {
    ...
    void testFinishAppointment_Success() {
        ...
        when(appointmentRepository.findById(any(ObjectId.class))).thenReturn(Optional.of(appointmentEntity));
    ...
    void testFinishAppointment_NotFound() {
        ...
        assertThrows(AppointmentNotFoundException.class, () -> appointmentService.finishAppointment(new ObjectId()));
    }
    ...
    void testFinishAppointment_NotAuthorized() {
        ...
        assertThrows(AppointmentException.class, () -> appointmentService.finishAppointment(new ObjectId()));
    }
...
//        when(userService.isUserAuthenticated()).thenReturn(true);
        ...
        assertThrows(AppointmentNotFoundException.class, () -> appointmentService.cancelAppointment(new ObjectId()));
    }
    ...
    void testBookAppointment_NotFound() {
        ...
        assertThrows(AppointmentNotFoundException.class, () -> appointmentService.bookAppointment(new ObjectId()));
    }
    ...
    void testCloseAppointment_NotFound() {
        ...
        assertThrows(AppointmentNotFoundException.class, () -> appointmentService.closeAppointment(new ObjectId()));
    }
    ...
    void testCloseAppointment_NotAuthorized() {
        ...
        assertThrows(NotAuthorizedException.class, () -> appointmentService.closeAppointment(new ObjectId()));
    }
    ...
    void testAddLinkToAppointment_NotFound() {
        ...
        assertThrows(AppointmentNotFoundException.class, () -> appointmentService.addLinkToAppointment(new ObjectId(), "http://lesson-link.com"));
    }
    ...
    void testAddLinkToAppointment_NotAuthorized() {
        ...
        assertThrows(NotAuthorizedException.class, () -> appointmentService.addLinkToAppointment(new ObjectId(), "http://lesson-link.com"));
    }
    ...
    void testGetStudentBookedAppointments() {
        ...
        when(appointmentRepository.findByStudentIdAndDateGreaterThanEqualOrderByDateAscTimeAsc(any(), any()))
                .thenReturn(List.of());
